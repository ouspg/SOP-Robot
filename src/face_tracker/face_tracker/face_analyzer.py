...
class FaceAnalyzer:
    def __init__(
        self,
        logger,
        lip_movement_detector: LipMovementDetector | None = None,
    ...
    def on_frame_received(self, frame: cv2.typing.MatLike):
        ...
        if self.frame == 0:
            ...
            # Reinitialize the lip detector if the number of detected faces changes.
            if self.lip_movement_detector is not None and faces_len_old != len(self.faces):
        ...
        for i, face in enumerate(self.faces):
            if self.lip_movement_detector is not None:
                ...
                face.speaking = self.lip_movement_detector.test_video_frame(
